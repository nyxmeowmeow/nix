  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      exec-once = [
        ...
        # ncmpcpp
        "hyprctl dispatch exec '[float;size 986 1200;center;workspace special:music silent] qview ~/nix/stuff/4_ncmpcpp.png' && sleep 3 && hyprctl dispatch exec '[float;size 986 1200;center;workspace special:music silent] foot -c ~/.config/foot/float.ini ncmpcpp'"

        # btop
        "hyprctl dispatch exec '[float;size 1600 1000;center;workspace special:btop silent] qview ~/nix/stuff/4_btop.png' && sleep 3 && hyprctl dispatch exec '[float;size 1600 1000;center;workspace special:btop silent] foot -c ~/.config/foot/float.ini btop'"

        # tty-clock
        "hyprctl dispatch exec '[float;size 968 526;center;workspace special:clock silent] qview ~/nix/stuff/4_clock.png' && sleep 3 && hyprctl dispatch exec '[float;size 968 526;center;workspace special:clock silent] foot -c ~/.config/foot/float.ini tty-clock -cC 4 -f %a,\\ %d\\ %b\\ %Y'"
