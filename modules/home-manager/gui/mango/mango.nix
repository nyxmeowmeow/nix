...
bind=SUPER,a,focusdir,down
bind=SUPER,e,focusdir,up
bind=SUPER,i,focusdir,right

# swap window
bind=SUPER+SHIFT,h,exchange_client,left
bind=SUPER+SHIFT,a,exchange_client,down
bind=SUPER+SHIFT,e,exchange_client,up
bind=SUPER+SHIFT,i,exchange_client,right

# switch window status
bind=SUPER,v,toggleglobal,
bind=SUPER,return,toggleoverview,
# bind=ALT,backslash,togglefloating,
bind=SUPER,m,togglemaximizescreen,
bind=SUPER+SHIFT,m,togglefullscreen,
bind=SUPER+SHIFT+CTRL,m,togglefakefullscreen,
bind=SUPER,minus,minimized,
bind=SUPER,slash,toggleoverlay,
bind=SUPER+SHIFT,minus,restore_minimized
bind=SUPER,comma,toggle_scratchpad

# scroller layout
bind=ALT,e,set_proportion,1.0
bind=SUPER+SHIFT,9,switch_proportion_preset,

# switch layout
# bind=SUPER+SHIFT,minus,switch_layout
