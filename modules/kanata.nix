...
(deflayermap sup
b (multi b (layer-switch base))
f (multi f (layer-switch base))
d (multi d (layer-switch base))
w (multi w (layer-switch base))
p (multi p (layer-switch base))
n (multi n (layer-switch base))
s (multi s (layer-switch base))
t (multi t (layer-switch base))
c (multi c (layer-switch base))
y (multi y (layer-switch base))
, (multi , (layer-switch base))
. (multi . (layer-switch base))
k (multi k (layer-switch base))
g (multi g (layer-switch base))
v (multi v (layer-switch base))
' (multi ' (layer-switch base))
l (multi l (layer-switch base))
o (multi o (layer-switch base))
u (multi u (layer-switch base))
j (multi j (layer-switch base))
x (multi x (layer-switch base))
m (multi m (layer-switch base))
h (multi h (layer-switch base))
a (multi a (layer-switch base))
e (multi e (layer-switch base))
i (multi i (layer-switch base))
